...
class CrystalPlot2D():
    ...
    def _plot_crystal_cell(self, crys, ax):
        ...
        self._plot_line(ax, p0, p1, zorder=-100)
        self._plot_line(ax, p1, p1+p2, zorder=-100)
        self._plot_line(ax, p1+p2, p2, zorder=-100)
        self._plot_line(ax, p2, p0, zorder=-100)
        self._plot_line(ax, p0+p3, p1+p3, zorder=-100)
        self._plot_line(ax, p1+p3, p1+p2+p3, zorder=-100)
        self._plot_line(ax, p1+p2+p3, p2+p3, zorder=-100)
        self._plot_line(ax, p2+p3, p0+p3, zorder=-100)
        self._plot_line(ax, p0, p0+p3, zorder=-100)
        self._plot_line(ax, p1, p1+p3, zorder=-100)
        self._plot_line(ax, p1+p2, p1+p2+p3, zorder=-100)
        self._plot_line(ax, p2, p2+p3, zorder=-100)
...
class CrystalPlot3D():
    ...
    def _plot_crystal_cell(self, crys, ax):
        ...
        self._plot_line(ax, p0, p1, zorder=1)
        self._plot_line(ax, p1, p1+p2, zorder=1)
        self._plot_line(ax, p1+p2, p2, zorder=1)
        self._plot_line(ax, p2, p0, zorder=1)

        self._plot_line(ax, p0+p3, p1+p3, zorder=1)
        self._plot_line(ax, p1+p3, p1+p2+p3, zorder=1)
        self._plot_line(ax, p1+p2+p3, p2+p3, zorder=1)
        self._plot_line(ax, p2+p3, p0+p3, zorder=1)

        self._plot_line(ax, p0, p0+p3, zorder=1)
        self._plot_line(ax, p1, p1+p3, zorder=1)
        self._plot_line(ax, p1+p2, p1+p2+p3, zorder=1)
        self._plot_line(ax, p2, p2+p3, zorder=1)
...
if __name__ == "__main__":
    ...
    #     newcell = unit.create_new_orientation(v1, v2, v3,
